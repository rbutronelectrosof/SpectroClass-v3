...
Los anchos equivalentes y razones alimentan tres clasificadores independientes: (1) un clasificador físico basado en criterios de intensidad de líneas con **árbol de decisión de 28 nodos** (ampliado desde 18), incluyendo 10 nuevos nodos para subtipos O3–O4 (N V + O V), O tardíos (N III), B con O II, F5–F9 (Ca I 4226/Hδ + Sr II 4077), F/G con banda CH G, G con Fe I 4144 + Cr I/Fe I + Y II 4376 (luminosidad), G con tripleta Mg b, K con triplete Cr I (4254/4275/4290) como termómetro primario, K con Na I D, y M tardías con VO y CaH; (2) un árbol interactivo web que replica el flujo de clasificación visual con zoom de líneas y manejo automático de espectros sin Ca II K; (3) clasificadores neuronales k-NN y CNN-1D sobre el espectro remuestreado a una grilla uniforme.
...
The resulting equivalent widths and ratios feed three independent classifiers: (1) a physical classifier based on line strength ratios and equivalent width criteria calibrated against MK standard stars, with a **28-node hierarchical decision tree** (expanded from 18), including 10 new nodes for O3–O4 (N V + O V), late O (N III), B with O II lines, F5–F9 subtypes (Ca I 4226/Hδ + Sr II 4077), F/G with the CH G-band, G subtypes using Fe I 4144/Hδ + Cr I/Fe I + Y II 4376 luminosity indicator, G with Mg b triplet, K using the Cr I triplet (4254/4275/4290 Å) as the primary temperature criterion, K with Na I D, and late M with VO and CaH; (2) an interactive web decision tree replicating the visual classification workflow with per-line EW zoom and automatic handling of spectra lacking Ca II K coverage; and (3) k-NN and 1D-CNN neural classifiers trained on spectra resampled over a uniform grid.

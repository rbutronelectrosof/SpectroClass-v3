...
2. [Módulo 1 — Clasificador Físico (28 nodos Gray & Corbally)](#módulo-1--clasificador-físico)
...
8. [Árbol Interactivo — Interfaz web (28 nodos)](#árbol-interactivo--interfaz-web)
...
| **Cr I** | 4254, 4275, 4290 Å | Triplete: termómetro primario G/K |
| **Y II** | 4376 Å | G/K gigante; Y II/Fe I 4383 ≥ 1 → clase III |
| **Ba II** | 4554 Å | K gigante (indicador luminosidad) |
| **Na I** | D 5890, 5896 Å | K tardía |
...
**Función principal:** `classify_star_decision_tree()` (árbol de 28 nodos)
...
### Tipos G — Fe I 4144, Cr I 4254 y Y II 4376 (criterios combinados)

> **Criterio primario de temperatura G:** Hδ 4101 vs Fe I 4144.
>
> - **Hδ > Fe I 4144** → G0 (Balmer aún domina sobre metales)
> - **Hδ ≈ Fe I 4144** → G2 (tipo solar, ~5 780 K)
> - **Hδ < Fe I 4144** → G5 (~5 500 K)
>
> **Criterio secundario:** Cr I 4254 vs Fe I 4260 — Fe I domina en G0–G2; Cr I ≈ Fe I en G5.
>
> **Indicador de luminosidad:** Y II 4376 / Fe I 4383. Si Y II 4376 ≥ Fe I 4383 → probable gigante (clase III) o supergigante. En enanas (V) Y II 4376 es notablemente débil.

| Hδ vs Fe I 4144 | Cr I 4254 vs Fe I 4260 | Subtipo G |
|-----------------|------------------------|-----------|
| Hδ > Fe I 4144 | Fe I > Cr I | G0–G2 |
| Hδ ≈ Fe I 4144 | Fe I ≈ Cr I | G2 (Sol G2V) |
| Hδ < Fe I 4144 | Cr I ≈ Fe I | G5 |
| Hδ < Fe I 4144 | Cr I > Fe I | G5–G8 → K |

### Tipos K — Triplete Cr I 4254/4275/4290 (termómetro primario)

> **Criterio principal K:** los tres Cr I (4254, 4275, 4290 Å) comparados con Fe I 4260 Å.
>
> El triplete completo es más discriminante que Ca I solo, porque Cr I crece de forma
> monotónica y bien calibrada desde K0 hasta K5, mientras que Ca I se satura en K tardío.
>
> - **Cr I 4254 ≈ Fe I 4260** → K0–K2 (Ca I fuerte pero no dominante)
> - **Cr I 4254 ≈ Cr I 4275, ambos > Fe I** → K3–K5
> - **Triplete completo ≥ 2× Fe I; Ca I dominante** → K5
> - **TiO emergente** → K7–M0
>
> **Luminosidad K:** Y II 4376/Fe I 4383 ≥ 1 → gigante K III. Ba II 4554 fuerte → supergigante.

| Condición triplete Cr I | Ca I 4226 | Subtipo K |
|------------------------|-----------|-----------|
| Cr I 4254 ≈ Fe I 4260 | Fuerte | K0–K2 |
| Cr I 4254 ≈ Cr I 4275, ambos > Fe I | Dominante | K3–K5 |
| Triplete completo ≥ 2× Fe I | Muy dominante | K5 |
| Ca I dominante + TiO emergente | Máximo | K7–M0 |
...
que mejor describe lo que ve. Contiene **28 nodos** (ampliado de 18 originales).

Cada nodo muestra el espectro cargado con el área EW de las líneas diagnóstico sombreada.
El usuario puede hacer clic en cualquier línea del gráfico o en el ícono 🔍 de la tabla
lateral para ampliar esa región. Si el espectro no cubre Ca II K (λ < 3934 Å), el árbol
detecta el rango automáticamente y redirige a nodos alternativos con criterios basados en
Hδ/Hγ + Mg II 4481 + Fe I 4383.

### Nodos del árbol (28 en total)
...
| `tipoF` | ¿Hδ/Hγ vs Ca I 4226? | → F0–F4 directo / tipoF_sub |
| `tipoF_sub` 🆕 | ¿Ca I 4226 / Hδ + Sr II 4077? | → F5–F6 / F7–F8 / F9 |
| `tipoFG_CH` 🆕 | ¿CH G-band 4300 visible? | → F5–G0 / F5–F8 |
| `tardias` | ¿Hδ vs Ca I 4226 + Fe I 4144? | → G0–G2 / G5 / K0+ |
| `tipoG` | ¿Hδ/Fe I 4144 + Cr I/Fe I + Y II 4376? | → tipoG_Mg (G0–G2) / G5 |
| `tipoG_Mg` 🆕 | ¿Mg I b triplete 5183 + Y II 4376? | → G0–G1 / G2 / G5–G8 |
| `tipoG5` | ¿Cr I/Ca I → G5 vs K0? | → G5 / K0 |
| `tipoK` | ¿Triplete Cr I (4254/4275/4290) vs Fe I 4260? | → tipoK_Na / K3–K5 / K5 / tipoKM |
| `tipoK_Na` 🆕 | ¿Na I D 5896 fuerte? + Y II 4376/Ba II 4554 | → K0–K1 / K2–K3 / K4–K5 |
| `tipoKM` | ¿TiO fuerte (bandas múltiples)? | → K5 / M0 / tipoM_sub / tipoM_late |
| `tipoM_sub` 🆕 | ¿VO 7434 visible + CaH 6382? | → M2–M3 / M4–M5 / M5–M6 |
| `tipoM_late` 🆕 | ¿VO 7865 > TiO 6651? | → M5–M6 / M7–M8 / M9–L0 |
| *… 5 nodos de resultado/confirmación* | Subtipos y confirmaciones | Resultados hoja |

*(Los nodos marcados con 🆕 son los 10 nuevos añadidos respecto a la versión anterior de 18 nodos.)*
...
|--------|------|-----------------------|:---------:|-----------|-----------|
| **Físico** | Reglas Gray & Corbally (28 nodos) | 15% / 10% | ~60-90% | Tipos O y B; transparente y auditable | F/G/K sin Ca II K (~5%) |
...
El árbol interactivo maneja este caso con nodos alternativos basados en Hδ + Mg II 4481.
El triplete Cr I (4254/4275/4290 Å) es el termómetro primario de tipo K, más sensible
que Ca I solo. Y II 4376 / Fe I 4383 añade un indicador de luminosidad independiente de
temperatura para G y K. Fe I 4144 / Hδ es el criterio primario para separar G0 de G5.*
